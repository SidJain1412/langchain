...
from langchain_classic.agents.agent_detector.output_parser import ConvoOutputParser
from langchain_classic.agents.agent_detector.prompt import (
    PREFIX,
    SUFFIX,
...
from langchain_classic.prompts.base import BasePromptTemplate
